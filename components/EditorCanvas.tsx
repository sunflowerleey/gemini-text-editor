...
export const EditorCanvas: React.FC<EditorCanvasProps> = ({
  ...
  useEffect(() => {
    ...
    canvas.on('selection:cleared', () => setSelectedProperties(null));
  ...
  const handlePropertyUpdate = (property: string, value: any) => {
    ...
    if (activeObject) {
      ...
      // Special handling for stroke width to ensure it doesn't clip
      if (property === 'strokeWidth' || property === 'fontSize') {
  ...
  return (
    <div className="h-full flex flex-col bg-slate-100 relative">
      ...
      {selectedProperties && (
        <PropertyPanel
          selectedObject={selectedProperties}
